...
import { BsGithub, BsLinkedin, BsPerson, BsTwitter, BsTelegram, BsDiscord, BsFacebook } from 'react-icons/bs'
...
export default function Contact() {
    const { hasCopied, onCopy } = useClipboard('Skopiowany mail')

    return (
        <Flex id="Kontakt"
            // bg={useColorModeValue('#f5f3f4')}
            bg={useColorModeValue('#F4F5FA')}
            align="center"
            justify="center"
            marginBottom={{
                base: '5rem',
                    ...
                    <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
                        ...
                        <Stack
                            ...
                            <Stack
                                ...
                                <Tooltip
                                    label={hasCopied ? 'Skopiowano!' : 'Skopiuj email'}
                                    closeOnClick={false}
                                    hasArrow>
                                    <IconButton
                                        aria-label="email"
